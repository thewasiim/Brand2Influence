...
export const GlowCursor = ({
  ...
  useEffect(() => {
    ...
    // Disable GlowCursor completely on mobile devices / touch screens
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uPointCount: { value: propsRef.current.trailLength },
        uColor: { value: hexToRgb(propsRef.current.color) },
        uSecondaryColor: { value: hexToRgb(propsRef.current.secondaryColor) },
        ...
        uNormalBlend: { value: propsRef.current.blendMode === 'normal' ? 1 : 0 },
        uTime: { value: 0 },
        uFade: { value: 0 }
      },
      transparent: true,
    ...
    const updatePointer = event => {
      ...
      const x = clamp(event.clientX, 0, w);
      const y = clamp(h - event.clientY, 0, h);
