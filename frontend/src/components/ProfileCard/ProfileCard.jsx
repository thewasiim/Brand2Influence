...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(44, 48, 21, 0.9) 0%, rgba(124, 58, 237, 0.4) 100%)';
            ...
            <div className="pc-bottom-info">
              <div className="pc-user-text-main">
                <div className="pc-name-row">
                  ...
                  <span className="pc-verified-icon" title="Verified Creator">✓</span>
                </div>
                <p className="pc-title-handle">
                  {handle} · {location}
                </p>
              ...
              <div className="pc-metrics-row">
                <div className="pc-metric-item">
                  <span className="pc-metric-val">{followersCount}</span>
                  <span className="pc-metric-lbl">Followers</span>
                </div>
                <div className="pc-metric-item">
                  <span className="pc-metric-val">{engagementRate}</span>
                  <span className="pc-metric-lbl">Eng. Rate</span>
                </div>
                <button
                  type="button"
