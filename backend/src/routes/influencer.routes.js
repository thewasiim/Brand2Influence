...
influencerRouter.post('/profile', authenticate, loadCurrentUser, allowRoles('influencer'), c.save)
influencerRouter.post('/social-sync', authenticate, loadCurrentUser, allowRoles('influencer'), c.syncSocial)
